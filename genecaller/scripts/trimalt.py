# Vendored from sentieon-cli (sentieon_cli/scripts/trimalt.py).
# Stream filter: reads merged VCF from stdin, drops pop-vcf-only sites,
# trims unsupported alt alleles, and rewrites Number=A/R/G INFO and FORMAT
# fields to match. Used in the pop_vcf annotation-transfer pipeline.
import re
import os
import sys
